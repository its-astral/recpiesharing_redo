      ...
      <div class="navbar-menu-wrapper d-flex align-items-top">
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text"><span class="text-black fw-bold text-capitalize">{{ Auth()->user()->name}}</span></h1>
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="countDropdown">
              ...
              <a class="dropdown-item preview-item">
                ...
                <div class="preview-item-content flex-grow py-2">
                  <p class="preview-subject ellipsis font-weight-medicancelled </p>
                </div>
              </a>
              <a class=" dropdown-item preview-item">
                  <div class="preview-thumbnail">
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="dashboard/images/faces/face8.jpg" alt="Profile image"> </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                <img class="img-md rounded-circle" src="dashboard/images/faces/face8.jpg" alt="Profile image">
              ...
              <a class="dropdown-item"><i class="dropdown-item-icon mdi mdi-power text-primary me-2" href=""></i>
                                  ...
                                  <table class="table select-table">
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex ">
                                            <img src="dahsboard/images/faces/face1.jpg" alt="">
                                            <div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="dashboard/images/faces/face2.jpg" alt="">
                                            <div>
                                              <h6>Laura Brooks</h6>
                                              <p>Head admin</p>
                                            </div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="dashboard/images/faces/face3.jpg" alt="">
                                            <div>
                                              <h6>Wayne Murphy</h6>
                                              <p>Head admin</p>
                                            </div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="dashboard/images/faces/face4.jpg" alt="">
                                            <div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="dashboard/images/faces/face5.jpg" alt="">
                                            <div>
                                  ...
                                  <div class="col-lg-12">
                                    ...
                                    <div class="mt-3">
                                      <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="dashboard/images/faces/face1.jpg" alt="profile">
                                      ...
                                      <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="dashboard/images/faces/face2.jpg" alt="profile">
                                          <div class="wrapper ms-3">
                                      ...
                                      <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="dashboard/images/faces/face3.jpg" alt="profile">
                                          <div class="wrapper ms-3">
                                      ...
                                      <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="dashboard/images/faces/face4.jpg" alt="profile">
                                          <div class="wrapper ms-3">
                                      ...
                                      <div class="wrapper d-flex align-items-center justify-content-between pt-2">
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="dashboard/images/faces/face5.jpg" alt="profile">
                                          <div class="wrapper ms-3">
